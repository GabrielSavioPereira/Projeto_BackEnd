...
## 🧩 Descrição Geral
A API foi será desenvolvida com o objetivo de gerenciar contas, categorias, transações e investimentos de um usuário, funcionando como uma planilha digital de controle financeiro.  
...
|----------------|--------|------|------------|
| Cadastrar usuário | POST | `/usuarios` | Cria um novo usuário. |
| Listar usuários | GET | `/usuarios` | Lista todos os usuários cadastrados. |
| Atualizar usuário | PUT | `/usuarios/{id}` | Atualiza as informações de um usuário. |
| Excluir usuário | DELETE | `/usuarios/{id}` | Remove um usuário do sistema. |
...
📅 **Autores:** Elyeser Gabrian, Gabriel Sávio Pereira e Vitor Botomé <br>
